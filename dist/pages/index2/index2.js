...
Page({
  ...
  goPlan: function goPlan() {
    var date = this.data.detailData.date.split('年');
    console.log(date);
    var y = date[0];
    var m = MONTH_ENGLISH[date[1].split('月')[0] - 1];
    var m_n = date[1].split('月')[0];
    // console.log(m)
    var d = date[1].split('月')[1];
    // console.log(d)
  ...
  selectDay: function selectDay(e) {
    ...
    var currentMonth = this.data.dateArr[i].dateData.arrInfoEx;
    var d = e.currentTarget.dataset.dayIndex;
  ...
  //获取对应日期的好友发起的套餐
  getfriend: function getfriend(page, time) {
    var that = this;
    var obj = {
  ...
  setTime: function setTime() {
    var y = this.data.detailData.curYear;
    var m = MONTH_ENGLISH[this.data.detailData.curMonth - 1];
    var m_n = this.data.detailData.curMonth;
    // console.log(m)
    var d = this.data.detailData.curDay;
    // console.log(d)
    wx.setStorageSync('time', { y: y, m: m, m_n: m_n, d: d });
  },
